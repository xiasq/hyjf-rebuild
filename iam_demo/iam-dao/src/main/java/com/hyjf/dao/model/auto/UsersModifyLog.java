...
public class UsersModifyLog implements Serializable {
    private Integer id;
    ...
    public void setBeforeModify(String beforeModify) {
        this.beforeModify = beforeModify == null ? null : beforeModify.trim();
    }
    ...
    public void setAfterModify(String afterModify) {
        this.afterModify = afterModify == null ? null : afterModify.trim();
    }
